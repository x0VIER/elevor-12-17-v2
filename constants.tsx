...
export const BLOG_POSTS: BlogPost[] = [
  {
    id: 1,
    title: "The Death of the Dashboard: Why AI Agents Are the New UI",
    excerpt: "Static charts are dead. Learn how autonomous agents are replacing passive monitoring with active resolution.",
    date: "Oct 12, 2024",
    readTime: "5 min read",
  ...
  {
    id: 2,
    title: "Case Study: How We Reduced Churn by 40% using NLP",
    excerpt: "A deep dive into the architecture of a sentiment analysis engine that predicts customer dissatisfaction.",
    date: "Sep 28, 2024",
    readTime: "8 min read",
  ...
  {
    id: 3,
    title: "Building Trustless Workflows on Private Ledgers",
    excerpt: "Why enterprise finance is moving to permissioned blockchains for automated auditing.",
    date: "Sep 15, 2024",
    readTime: "6 min read",
...
export const FAQ_ITEMS: FaqItem[] = [
  {
    question: "How is ELEVOR different from a standard dev shop?",
    answer: "We don't just build software; we architect autonomous systems. Our focus is on 'Agentic AI'—systems that observe, decide, and act without human intervention, rather than just passive tools."
  },
  {
    question: "Do you work with existing engineering teams?",
    answer: "Yes. Our 'Senior Engineering Augmentation' and 'Virtual CTO' services are designed to integrate seamlessly with your in-house talent, injecting specialized AI expertise where needed."
  },
  {
    question: "What is your typical engagement timeline?",
    answer: "Our 'Rapid MVP Build Sprint' delivers functional software in 4-6 weeks. Enterprise transformations typically run 3-6 months depending on complexity and integration requirements."
  },
  {
    question: "How do you handle data privacy and security?",
    answer: "Security is foundational. We deploy on private instances (VPC), utilize local LLMs where sensitive data is involved, and adhere to SOC2 and HIPAA compliance standards."
  }
];

export const STATS: StatItem[] = [
  { label: "Active Agents Deployed", value: "12,500+" },
  { label: "Enterprise Partners", value: "85+" },
  { label: "Revenue Generated for Clients", value: "$450M+" },
